                ...
                <div class="col-sm-10 text-left"> 
                    ...
                    <div class="container-fluid" >
                        <ul>
                            ...
                            <li style="display: inline" class="active">System Users</li>
                        </ul>
                                    ...
                                    <%
                                        for (String[] strings : List) {
                                           ...
                                           //out.println(email);
                                            ...
                                            out.println("<td><a href='Delteuser?val="+email+"' ><button type='submit' class='btn btn-danger ' onclick='return clicked()'>Remove</button> </a></td>");
                                            out.println("</tr>");
                                        }
